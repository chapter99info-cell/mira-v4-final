...
import {
  ...
  SERVICE_THAI_RELAXATION_IMAGE,
  SERVICE_THAI_DEEP_TISSUE_OIL_IMAGE,
  SERVICE_THAI_NO_OIL_IMAGE,
  SERVICE_ACCREDITED_OIL_IMAGE,
  SERVICE_ACCREDITED_DEEP_TISSUE_IMAGE,
...
export const brandConfig = {
  ...
  phone: "0466992456",
  /** Supabase `bookings.shop_id` for staff realtime alerts (override via VITE_SHOP_ID). */
  shopId: (import.meta.env.VITE_SHOP_ID as string | undefined) || 'mira-altona',
  bookingUrl:
  ...
  services: [
    {
      ...
      depositAmount: 30,
      duration: 60,
      image: SERVICE_THAI_RELAXATION_IMAGE,
    ...
    },
    {
      ...
      depositAmount: 30,
      duration: 60,
      image: SERVICE_THAI_DEEP_TISSUE_OIL_IMAGE,
    ...
    },
    {
      ...
      depositAmount: 30,
      duration: 60,
      image: SERVICE_THAI_NO_OIL_IMAGE,
    ...
    },
    {
      ...
      depositAmount: 40,
      duration: 60,
      image: SERVICE_ACCREDITED_OIL_IMAGE,
    ...
    },
    {
      ...
      depositAmount: 40,
      duration: 60,
      image: SERVICE_ACCREDITED_DEEP_TISSUE_IMAGE,
